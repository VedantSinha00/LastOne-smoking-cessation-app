...
export function OB01Logo() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background items-center justify-center">
      <Text className="text-primary font-display text-5xl">LastOne</Text>
      <Text className="text-muted-foreground text-base mt-3">Your last cigarette starts here.</Text>
    </SafeAreaView>
  )
}
  ...
  return (
    <OBScreen footer={<OBContinue title="Get Started" onPress={nextStep} />}>
      <View className="flex-1 justify-center">
        <Text className="text-foreground font-display text-3xl leading-9">
          You don't have to have it all figured out.
        </Text>
        <Text className="text-muted-foreground text-base mt-4 leading-relaxed">
...
export function OB03Intro() {
  ...
  return (
    <OBScreen onBack={prevStep} footer={<OBContinue onPress={nextStep} />}>
      <View className="flex-1 justify-center">
        <Text className="text-foreground font-display text-2xl leading-8">This isn't a lecture.</Text>
        <Text className="text-muted-foreground text-base mt-4 leading-relaxed">
...
export function OB04Promise() {
  ...
  return (
    <OBScreen onBack={prevStep} footer={<OBContinue onPress={nextStep} />}>
      <View className="flex-1 justify-center">
        <Text className="text-foreground font-display text-2xl leading-8">A quick promise.</Text>
        <Text className="text-muted-foreground text-base mt-4 leading-relaxed">
...
export function OB09Buffer1() {
  ...
  return (
    <OBScreen onBack={prevStep} footer={<OBContinue title="Let's go" onPress={nextStep} />}>
      <View className="flex-1 justify-center">
        <Text className="text-foreground font-display text-2xl leading-8">Good start{name}.</Text>
        <Text className="text-muted-foreground text-base mt-4 leading-relaxed">
...
export function OB18Buffer2() {
  ...
  return (
    <OBScreen onBack={prevStep} footer={<OBContinue onPress={nextStep} />}>
      <View className="flex-1 justify-center">
        <Text className="text-foreground font-display text-2xl leading-8">
